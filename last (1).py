...
st.subheader('Aantal werknemers die het bedrijf hebben verlaten vs. gebleven met overuren (overtime) als factor')
...
if median_values[0] < median_values[1]:
    conclusion = f"De mediaan jaren sinds de laatste promotie voor werknemers die zijn vertrokken is **{median_values[1]}** " \
